...
```
bash <(curl -Ls https://raw.githubusercontent.com/ava6767/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/ava6767/3x-ui/master/install.sh) v2.3.6
```
